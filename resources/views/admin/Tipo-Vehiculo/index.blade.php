                    ...
                    <div class="table-responsive">
                        <table class="table table-premium-mod table-hover mb-0">
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <strong class="text-white text-uppercase" style="font-size: 0.88rem; letter-spacing: 0.2px;">
                                                <i class="fas fa-truck-moving mr-2" style="color: #0EA5E9; opacity: 0.8; font-size: 0.85rem;"></i>{{ $tipoVehiculo->nombre }}
                                            </strong>
                                        </td>
                                        <td>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="text-center py-5" style="background-color: transparent;">
                                            <i class="fas fa-folder-open fa-3x mb-3" style="color: rgba(255, 255, 255, 0.15);"></i>
                                            <p class="mb-0 font-weight-bold" style="color: rgba(255, 255, 255, 0.45);">No hay tipos de vehículo registrados.</p>
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
        ...
        <div class="modal-content modal-premium-box border-0 shadow-lg">
            <form action="{{ route('admin.tipo-vehiculo.store') }}" method="POST">
                ...
                <div class="modal-header-premium border-bottom-divider py-3 px-4 d-flex align-items-center justify-content-between">
                    ...
                    <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close" style="opacity: 0.6; background: transparent; border: none; font-size: 1.5rem;">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body p-4">
                    ...
                    <div class="form-group mb-4">
                        <label for="nombre_modal" class="premium-label">Nombre <span class="required-dot">*</span></label>
                        <div class="input-group">
                            ...
                            >
                            @error('nombre')
                                <span class="invalid-feedback font-weight-bold mt-2" style="color: #F87171;"><i class="fas fa-exclamation-circle mr-1"></i>{{ $message }}</span>
                            @enderror
                        </div>
                        <small class="form-text-hint"><i class="fas fa-info-circle mr-1"></i>Letras, números, espacios y tildes. Máx. 100 caracteres.</small>
                    </div>
                    ...
                    <div class="form-group mb-2">
                        ...
                        <textarea
                            ...
                            class="form-control premium-textarea @error('descripcion') is-invalid @enderror"
                            rows="3"
                            maxlength="255"
                        ...
                        <div class="d-flex justify-content-between mt-2">
                            <small class="form-text-hint"><i class="fas fa-info-circle mr-1"></i>Detalles breves del tipo.</small>
                            <small class="form-text-hint font-weight-bold"><span id="desc-count-modal" style="color: #0EA5E9;">0</span>/255</small>
                        </div>
                    </div>
...
<div class="modal fade" id="modalEliminar" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content modal-premium-box border-0 shadow-lg">
            ...
            <div class="modal-body p-4">
                <p class="mb-3 text-white" style="font-size: 1rem; font-weight: 500;">¿Está completamente seguro de eliminar el tipo de vehículo <strong id="nombreEliminar" style="color: #EF4444; text-shadow: 0 0 10px rgba(239,68,68,0.2);"></strong>?</p>
...
<style>
    ...
    .header-module-container { margin-bottom: 10px; }
    ...
    .btn-action-edit:hover { background: #0EA5E9 !important; color: #fff !important; transform: scale(1.05); text-decoration: none; }
    ...
    .modal-header-premium { background: transparent; }
    .modal-footer-premium { background: transparent; }
    ...
    .btn-premium-modal-save:hover { transform: translateY(-1px); box-shadow: 0 6px 15px rgba(14, 165, 233, 0.3); }
    ...
    .btn-premium-modal-close {
        ...
        font-size: 14px !important; padding: 10px 22px !important; transition: all 0.2s;
    }
    ...
    .btn-premium-modal-danger:hover { transform: translateY(-1px); box-shadow: 0 6px 15px rgba(239, 68, 68, 0.3); }

    /* CAJA DE ADVERTENCIA ELIMINAR */
    .premium-danger-notice {
        display: flex; align-items: flex-start;
        background: rgba(239, 68, 68, 0.08); border-left: 4px solid #EF4444;
        padding: 12px 16px; border-radius: 8px; color: #FCA5A5; font-size: 0.88rem;
    }
