                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            @enderror
                            <small class="form-text text-muted"><i class="fas fa-info-circle mr-1"></i>Letras, números y guión. Ej: ABC-123. Máx. 10 caracteres.</small>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            @error('modelo')
                                <div class="invalid-feedback"><i class="fas fa-exclamation-circle mr-1"></i>{{ $message }}</div>
                            @enderror
                            <small class="form-text text-muted"><i class="fas fa-info-circle mr-1"></i>Letras y números. Ej: NHR 2022. Máx. 100 caracteres.</small>
                        </div>
                    </div>
