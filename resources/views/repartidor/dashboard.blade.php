        ...
        <div class="d-flex justify-content-between align-items-center">
            <div>
                ...
                <p class="mb-0 mt-1" style="font-size: 0.85rem; color: #a0aec0;">
                    <i class="fas fa-calendar-day mr-1"></i>Ruta de hoy: {{ \Carbon\Carbon::now()->format('d/m/Y') }}
                </p>
            </div>
        ...
        <div class="row mb-4" style="gap: 0;">
            <div class="col-6 col-md-3 mb-3">
                <div style="background:#242b3d; border:1px solid rgba(255,255,255,0.07); border-radius:12px; padding:1rem; text-align:center;">
                    <div style="font-size:1.6rem; font-weight:700; color:#e2e8f0;">{{ $total }}</div>
            ...
            <div class="col-6 col-md-3 mb-3">
                <div style="background:#242b3d; border:1px solid rgba(78,154,241,0.2); border-radius:12px; padding:1rem; text-align:center;">
                    <div style="font-size:1.6rem; font-weight:700; color:#4e9af1;">{{ $enRuta }}</div>
            ...
            <div class="col-6 col-md-3 mb-3">
                <div style="background:#242b3d; border:1px solid rgba(72,199,142,0.2); border-radius:12px; padding:1rem; text-align:center;">
                    <div style="font-size:1.6rem; font-weight:700; color:#48c78e;">{{ $entregado }}</div>
            ...
            <div class="col-6 col-md-3 mb-3">
                <div style="background:#242b3d; border:1px solid rgba(160,174,192,0.15); border-radius:12px; padding:1rem; text-align:center;">
                    <div style="font-size:1.6rem; font-weight:700; color:#a0aec0;">{{ $pendiente }}</div>
                    ...
                    <div class="guia-card">
                        ...
                        <div class="card-top">
                            <div class="guia-num">
                                ...
                                Guía <span>#{{ $guia->num_guias ?? $guia->id }}</span>
                            </div>
                            <span class="estado-badge badge-{{ $badgeClass }}">{{ $estadoActual }}</span>
                        </div>
                        ...
                        <div class="guia-body">
                            ...
                            <div class="info-row">
                                ...
                                <div>
                                    ...
                                    <div class="info-value">{{ $guia->clienteDestino->direccion ?? 'Sin dirección' }}</div>
                                    <a href="https://www.google.com/maps/search/?api=1&query={{ urlencode(($guia->clienteDestino->direccion ?? '') . ', ' . ($guia->clienteDestino->ciudad ?? '')) }}"
                            ...
                            <div class="info-row">
                                ...
                                <div>
                                    ...
                                    <div class="info-value">{{ $guia->clienteDestino->nombre ?? 'Desconocido' }}</div>
                                </div>
                            </div>
                            ...
                            <div class="info-row">
                                ...
                                <div>
                                    ...
                                    <a href="tel:{{ $guia->clienteDestino->telefono ?? '#' }}" class="tel-link">
                                        {{ $guia->clienteDestino->telefono ?? 'N/A' }}
                                    </a>
                                </div>
                            </div>
                        ...
                        {{-- Botones de acción --}}
                        <div class="acciones">
                            @if($estadoActual !== 'En ruta' && $estadoActual !== 'Entregado')
                                <form action="{{ route('repartidor.estado', $guia->id) }}" method="POST" style="flex:1; min-width:110px;">
                                    @csrf
                            ...
                            @if($estadoActual !== 'Novedad/Devolución' && $estadoActual !== 'Entregado')
                                <form action="{{ route('repartidor.estado', $guia->id) }}" method="POST" style="flex:1; min-width:110px;">
                                    @csrf
