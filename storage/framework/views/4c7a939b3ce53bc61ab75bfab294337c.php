<?php $__env->startSection('title', 'Guías'); ?>
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $guias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $guia): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td><?php echo e($guia->id); ?></td>
                                <td><?php echo e($guia->tipoEntrega->nombre ?? '—'); ?></td>
                                
                                
                                <td><?php echo e($guia->clienteOrigen->nombre ?? '—'); ?></td>
                                <td><?php echo e($guia->clienteDestino->nombre ?? '—'); ?></td>
                                
                             
                                <td><?php echo e($guia->unidades); ?></td>
                                <td><?php echo e($guia->peso); ?></td>

                                <td><?php echo e($guia->largo); ?></td>
                                <td><?php echo e($guia->ancho); ?></td>
                                <td><?php echo e($guia->alto); ?></td>

                                <td><?php echo e($guia->precio_envio); ?></td>
                                <td><?php echo e($guia->valor_declarado); ?></td>
                                
                                <td><?php echo e($guia->repartidor->name ?? 'Sin asignar'); ?></td>
                                <td><?php echo e($guia->observacion ?? '—'); ?></td>

                                <td class="text-center">
                                    <a href="<?php echo e(route('admin.guia.edit', $guia->id)); ?>" class="btn btn-warning btn-xs"
                                        title="Editar">
    ...
    <div class="modal fade" id="modalCrear" tabindex="-1" role="dialog" aria-labelledby="modalCrearLabel"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('admin.guia.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select name="id_tipo_entrega" class="form-control" required>
                                        ...
                                        <?php $__currentLoopData = $tipoEntregas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="id_repartidor" class="form-control select2" style="width: 100%;">
                                        ...
                                        <?php $__currentLoopData = $repartidores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $repartidor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($repartidor->id); ?>">
                                                <?php echo e($repartidor->name); ?> (<?php echo e($repartidor->email); ?>)
                                            </option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                                    ...
                                    <select name="id_cliente_origen" class="form-control" required>
                                        ...
                                        <?php $__currentLoopData = $clientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cliente): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($cliente->id); ?>">
                                               <?php echo e($cliente->cedula); ?>  <?php echo e($cliente->nombre); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="unidades" class="form-control"
                                        value="<?php echo e(old('unidades', 1)); ?>" min="1">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Peso (Kg)</label>
                                    <input type="number" name="peso" class="form-control" value="<?php echo e(old('peso', 1)); ?>"
                                        step="0.01">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="largo" class="form-control"
                                        value="<?php echo e(old('largo', 1)); ?>" step="0.01">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="ancho" class="form-control"
                                        value="<?php echo e(old('ancho', 1)); ?>" step="0.01">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="alto" class="form-control"
                                        value="<?php echo e(old('alto', 1)); ?>" step="0.01">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="precio_envio" class="form-control"
                                        value="<?php echo e(old('precio_envio', 9800)); ?>" step="0.01">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="valor_declarado" class="form-control"
                                        value="<?php echo e(old('valor_declarado', 20000)); ?>" step="0.01">
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="observacion" rows="3" class="form-control"><?php echo e(old('observacion')); ?></textarea>
                                </div>
                            </div>
...
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ASUS\Desktop\logistica\resources\views/admin/guia/index.blade.php ENDPATH**/ ?>