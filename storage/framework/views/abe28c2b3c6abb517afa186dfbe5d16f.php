<?php $__env->startSection('title', 'Tipos de Vehículo — Carga y Logística Tolima'); ?>
                    ...
                    <div class="card-header-premium d-flex align-items-center justify-content-between">
                        ...
                        <div class="card-tools d-flex align-items-center" style="gap: 12px;">
                            <span class="badge-count-premium">
                                Total: <?php echo e($tipoVehiculos->total()); ?>
                    ...
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="table table-premium-mod table-hover mb-0">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $tipoVehiculos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $tipoVehiculo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td class="text-center font-weight-bold"
                                                style="color: rgba(255, 255, 255, 0.35);">
                                                <?php echo e($tipoVehiculos->firstItem() + $index); ?>
                                            ...
                                            <td>
                                                <strong class="text-white text-uppercase"
                                                    ...
                                                    <i class="fas fa-truck-moving mr-2"
                                                        style="color: #0EA5E9; opacity: 0.8; font-size: 0.85rem;"></i><?php echo e($tipoVehiculo->nombre); ?>

                                                </strong>
                                            </td>
                                            <td>
                                                <span style="color: rgba(255, 255, 255, 0.65); font-size: 0.85rem;">
                                                    <?php echo e($tipoVehiculo->descripcion ?? '—'); ?>
                                            ...
                                            <td class="text-center">
                                                <div class="d-inline-flex" style="gap: 6px;">
                                                    ...
                                                    <a href="<?php echo e(route('admin.tipo-vehiculo.edit', $tipoVehiculo->id)); ?>"
                                                    ...
                                                    <form
                                                        action="<?php echo e(route('admin.tipo-vehiculo.destroy', $tipoVehiculo->id)); ?>"
                                                        method="POST" class="d-inline form-eliminar">
                                                        <?php echo csrf_field(); ?>
                                                        <?php echo method_field('DELETE'); ?>
                                                        <button type="button" class="btn-action-delete btn-eliminar"
                                                            title="Eliminar" data-nombre="<?php echo e($tipoVehiculo->nombre); ?>">
    ...
    <div class="modal fade" id="modalCrear" tabindex="-1" role="dialog" aria-labelledby="modalCrearLabel"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-premium-box border-0 shadow-lg">
                <form action="<?php echo e(route('admin.tipo-vehiculo.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div
...
unset($__errorArgs, $__bag); ?>"
                                    value="<?php echo e(old('nombre')); ?>" placeholder="Ej: Camión 5 Ton" maxlength="100"
...
unset($__errorArgs, $__bag); ?>" rows="3" maxlength="255"
                                placeholder="Opcional..." style="resize: none;"><?php echo e(old('descripcion')); ?></textarea>
...
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ASUS\Desktop\logistica\resources\views/admin/tipo-vehiculo/index.blade.php ENDPATH**/ ?>